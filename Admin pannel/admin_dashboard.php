    ...
    <div class="row" style="margin-left:15px;margin-right:15px;">
      ...
      <div class="col-md-3">
        <div class="card">
          ...
          <div class="card-footer">
          <button type="button" class="btn btn-sm btn-danger" onclick="generatePDF()">View Report</button>
<script>
function generatePDF() {
    window.location.href = 'generate_pdf.php'; // Redirect to the PHP script that generates the PDF
}
</script>
          </div>
        </div>
